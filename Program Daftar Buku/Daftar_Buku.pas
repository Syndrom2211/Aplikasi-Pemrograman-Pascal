...
{I.S : Stok Buku dan Harga beli sudah tedefinisi}
...
// ----------------------------Urut Harga Beli----------------------------------
     ...
     temp2 := Book[max].Harga_Beli;
     Book[max].Harga_Beli := Book[j].Harga_Beli;
     Book[j].Harga_Beli := temp2;
     x := x - 1;
     end;
// ----------------------------Urut Harga Jual----------------------------------
    x := N;
     ...
     temp3 := Book[max].Harga_Jual;
     Book[max].Harga_Jual := Book[j].Harga_Jual;
     Book[j].Harga_Jual := temp3;
     x := x - 1;
     end;
// ----------------------------Urut Stok----------------------------------------
    x := N;
